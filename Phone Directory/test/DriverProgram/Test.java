...
public class Test 
{
		...
		public static void main(String args[])
		{
			...
			Properties.populateInMem(myPhone);
			String ans = "y";
			...
			{//This while loops runs constantly allowing the user to enter as much as 10 new entries and unlimited other options
				...
				case 1:
					...
					myPhone.addEntry(Properties.getUserName(), Properties.getUserNum());
					entryCount ++;
					break;
				case 2:
					myPhone.delEntry(Properties.getUserName());
					break;
				case 3:
					String aname = Properties.getUserName();
					String num;
					num = myPhone.getNum(aname);
					System.out.println("Name is: " + aname + "\nNumber is: " + num);
					break;
				case 4:
					myPhone.updateEntry(Properties.getUserName(), Properties.getUserNum(), Properties.getUserName());
					break;
				case 5:
